...
export default function LoginScreen() {
  ...
  const fazerLogin = () => {
    // Simulação de login - Redireciona para a Home (index)
    router.replace('/home');
  };
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputContainer}>
                ...
                <TouchableOpacity onPress={() => setMostrarSenha(!mostrarSenha)} style={styles.eyeIcon}>
                  <Ionicons name={mostrarSenha ? "eye-off-outline" : "eye-outline"} size={20} color={theme.colors.gray_500} />
                </TouchableOpacity>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  logoCircle: { width: 80, height: 80, borderRadius: 40, backgroundColor: theme.colors.primary, justifyContent: 'center', alignItems: 'center', marginBottom: 16, elevation: 4 },
  ...
  forgotPasswordText: { color: theme.colors.primary, fontSize: 14, fontWeight: 'bold' },

  loginButton: { flexDirection: 'row', backgroundColor: theme.colors.primary, height: 56, borderRadius: 12, justifyContent: 'center', alignItems: 'center', elevation: 2 },
  loginButtonText: { color: theme.colors.white, fontSize: 18, fontWeight: 'bold' },

  footer: { marginTop: 40, alignItems: 'center' },
  footerText: { fontSize: 14, color: theme.colors.gray_500, marginBottom: 8 },
  registerLink: { fontSize: 16, fontWeight: 'bold', color: theme.colors.orange_500 },
});