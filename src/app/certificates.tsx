...
export default function CertificatesScreen() {
  ...
  const onAddCertificate = () => {
    if (
      ...
      Alert.alert(
        "Campos obrigatórios",
        "Preencha título, número, órgão emissor, emissão e validade.",
      );
      return;
    }
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top"]}>
      ...
      />
      <AppHeader
        title="Certificados MAPA"
        subtitle="Gestão de conformidade e confiança"
      ...
      >
        <View style={styles.stateTabs}>
          <TouchableOpacity
            style={[
              styles.stateTab,
              status === "create" && styles.stateTabActive,
            ]}
            onPress={() => setStatus("create")}
          >
            <Text
              style={[
                styles.stateTabText,
                status === "create" && styles.stateTabTextActive,
              ]}
            >
              Cadastrar novo
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.stateTab,
              status === "pending" && styles.stateTabActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.stateTabText,
                status === "pending" && styles.stateTabTextActive,
              ]}
            >
              Em análise
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.stateTab,
              status === "approved" && styles.stateTabActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.stateTabText,
                status === "approved" && styles.stateTabTextActive,
              ]}
            >
              Aprovado
            </Text>
        ...
        <SurfaceCard style={styles.infoCard}>
          <Text style={styles.infoTitle}>
            Porque cadastrar seus certificados?
          </Text>
          <Text style={styles.infoText}>
            • Reforçar credibilidade comercial no seu perfil público.
          </Text>
          <Text style={styles.infoText}>
            • Centralizar documentos para acelerar negociações no chat.
          </Text>
          <Text style={styles.infoText}>
            • Controlar vigência e status dos certificados oficiais.
          </Text>
        </SurfaceCard>
        ...
        currentCertificates.length === 0 ? (
          <SurfaceCard style={styles.emptyCard}>
            ...
            <Text style={styles.emptyTitle}>
              Nenhum certificado nesse estado
            </Text>
            <Text style={styles.emptyText}>
              Use a aba "Cadastrar novo" para adicionar um certificado e definir
              o status inicial.
            </Text>
          </SurfaceCard>
        ) : null}
        ...
        {currentCertificates.map((item) => (
          <SurfaceCard key={item.id} style={styles.certificateCard}>
            <View style={styles.certificateHeader}>
              ...
              >
                <Text style={styles.badgeText}>
                  {status === "approved" ? "Ativo" : "Em análise"}
                </Text>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  headerSubtitleOverride: { fontSize: 13 },
  stateTabs: {
    flexDirection: "row",
